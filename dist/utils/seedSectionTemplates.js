...
exports.ensureSectionTemplatesSeeded = ensureSectionTemplatesSeeded;
const SectionTemplate_1 = require("../models/SectionTemplate");
const seedSectionTemplates = [
    {
        templateId: 'tc-v1',
...
async function ensureSectionTemplatesSeeded() {
    if (seedSectionTemplates.length === 0)
        return;
    await SectionTemplate_1.SectionTemplate.bulkWrite(seedSectionTemplates.map((t) => ({
        updateOne: {
