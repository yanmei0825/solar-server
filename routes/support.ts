...
import { ContactRequest, ConsultationRequest } from '../types';
...
router.post('/contactus', async (req: Request<{}, {}, ContactRequest>, res: Response): Promise<void> => {
    try {
...
router.post('/consultation', async (req: Request<{}, {}, ConsultationRequest>, res: Response): Promise<void> => {
    try {
        const {
            fullName,
            companyName,
        ...
        // Format email content in a readable style
